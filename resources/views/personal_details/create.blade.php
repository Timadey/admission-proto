                    ...
                    <div class="p-6 text-gray-900 ">
                            ...
                            <form class="mx-auto lg:w-[50%]" action="{{ route('personal-detail.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="block w-full m-4">
                                    ...
                                    <x-text-input id="surname" name="surname" value="{{ old('surname', '') }}" class="h-12 border border-gray-300 text-gray-600 text-base rounded-lg block w-full py-2.5 px-4 focus:outline-none">
                                    </x-text-input>
                                ...
                                <div class="block w-full m-4">
                                    ...
                                    <x-text-input id="other_names" name="other_names" value="{{ old('other_names', '') }}"  class="h-12 border border-gray-300 text-gray-600 text-base rounded-lg block w-full py-2.5 px-4 focus:outline-none">
                                    </x-text-input>
                                ...
                                <div class="block w-full m-4">
                                    ...
                                    <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', '') }}" class="h-12 border border-gray-300 text-gray-600 text-base rounded-lg block w-full py-2.5 px-4 focus:outline-none">
                                    </input>
                                ...
                                <div class="block w-full m-4">
                                    ...
                                    <x-text-input id="current_residential_address" value="{{ old('current_residential_address', '') }}" name="current_residential_address" class="h-12 border border-gray-300 text-gray-600 text-base rounded-lg block w-full py-2.5 px-4 focus:outline-none">
                                    </x-text-input>
